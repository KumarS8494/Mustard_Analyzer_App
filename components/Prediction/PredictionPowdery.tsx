...
const PredictionPowdery = ({ title, description, sampleImages }: PredictionPowderyProps) => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const End_Point = "https://kumars81-mustard-wheat-disease-api.hf.space/predict/powdery"
...
export default PredictionPowdery;